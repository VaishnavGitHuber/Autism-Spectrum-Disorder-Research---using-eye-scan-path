# -*- coding: utf-8 -*-
"""Autism_Full_Image_TranslationII.ipynb
...
transformed_path = os.path.join("/content/drive/MyDrive/", "TransformedImages_NoSkeleton")
...
# Processing function (no skeletonization)
def preprocess_image_no_skeleton(img_path):
    # Load image
    ...
    # Resize
    final_img = cv2.resize(dilated, (224, 224))
...
for folder in folders:
    ...
    for filename in os.listdir(input_folder):
        if filename.lower().endswith((".png", ".jpg", ".jpeg")):
            ...
            transformed_img = preprocess_image_no_skeleton(img_path)

            save_path = os.path.join(output_folder, filename)
            cv2.imwrite(save_path, transformed_img)

print("All images transformed and saved successfully without skeletonization!")